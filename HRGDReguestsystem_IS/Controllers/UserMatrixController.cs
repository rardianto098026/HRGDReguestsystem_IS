...
using static HRGDReguestsystem_IS.Models.MenuViewModels;
using HRGDReguestsystem_IS.Repository;
using HRDDReguestsystem_IS.Models;
...
namespace HRGDReguestsystem_IS.Controllers
{
    public class UserMatrixController : Controller
    {
        ...
        public ActionResult Pending(UserMatrix model, string submit)
        {
            ...
            {
                return RedirectToAction("UploadPage", "UserMatrix");
            }
        ...
        [HttpPost]
        public ActionResult UploadPage(HttpPostedFileBase file, string submit)
        {
            if (Session["UserID"] == null)
            {
        ...
        public static List<UserMatrix> GetEmployeeData(string ID, string Name, string entity, string role)
        {
            ...
            List<HRGDReguestsystem_IS.Models.UserMatrix> model = new List<UserMatrix>();
